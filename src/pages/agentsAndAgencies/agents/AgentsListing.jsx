          ...
          <div className="row align-items-center justify-content-center">
            <div className="col-lg-5 agency_list">
              <div className="agent_info_image agent_info_image2 agent_pennel_2">
                <div>
                  <Link to={pageRoutes.AGENT_INFO}><img src={contact_photo}className="img-fluid" /></Link>
                </div>
                <div>
                  <h3>John Smith</h3>
                  <p><b>Agent:</b> Property Finders</p>
                  <p><b>Exp.:</b> 11 years <span className="ratt"><i className="ri-star-fill" /> 4.2</span></p>
                  <p><b>Nationally:</b> Indian</p>
            ...
            <div className="col-lg-5 agency_list">
              <div className="agent_info_image agent_info_image2 agent_pennel_2">
                <div>
                  <a href="agent-info.php"><img src={contact_photo} className="img-fluid" /></a>
                </div>
                <div>
                  <h3>John Smith</h3>
                  <p><b>Agent:</b> Property Finders</p>
                  ...
                  <a href="agent-info.php" className="action_btn popp"><i className="ri-arrow-right-up-long-line" /></a></div>
                <img src={property_world_logo} className="a_logo" />
              </div>
            </div>
            <div className="col-lg-5 agency_list">
