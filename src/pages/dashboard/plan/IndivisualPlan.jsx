            ...
            <div className="row">
              ...
              <div className="pricing-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                <div className="inner-box">
                  ...
                  <div className="price-box">
                    <div className="title">Basic Listing</div>
              ...
              <div className="pricing-block col-lg-4 col-md-6 col-sm-12 wow fadeInUp">
                <div className="inner-box">
                  ...
                  <div className="price-box">
                    <div className="title">Premium Listing (Silver)</div>
              ...
              >
                <div className="inner-box">
                  ...
                  <div className="price-box">
                    <div className="title">Premium Listing (Gold)</div>
             ...
             <div
              ...
              >
                <div className="inner-box">
                  ...
                  <div className="price-box">
                    <div className="title">Premium Listing (Platinum)</div>
