...
import PrivacyPolicySkeleton from "../../Custom_Components/Skeleton/PrivacyPolicySkeleton";

function PrivacyAndPolicyContent({ innerRef }) {
...
export default React.memo(PrivacyAndPolicyContent);
